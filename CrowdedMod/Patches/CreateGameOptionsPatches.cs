        ...
        static class SaveManager_get_GameHostOptions
        {
	        static bool Prefix(out GameOptionsData __result)
	        {
		        ...
		        SaveManager.hostOptionsData.NumImpostors = 
			        Mathf.Clamp(SaveManager.hostOptionsData.NumImpostors, 1, SaveManager.hostOptionsData.MaxPlayers - 1); // NumImpostors = Clamp(1, MaxPlayers-1)
		        SaveManager.hostOptionsData.KillDistance = Mathf.Clamp(SaveManager.hostOptionsData.KillDistance, 0, 2); // KillDistance
